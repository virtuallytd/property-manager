    ...
    <div className="card p-5 flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex gap-1 shrink-0">
          <button onClick={onEdit} className="btn p-1.5" title="Edit">
            <Pencil size={14} />
          </button>
          <button onClick={onDelete} className="btn p-1.5 text-red-500 hover:bg-red-50 hover:border-red-200" title="Delete">
            <Trash2 size={14} />
          </button>
        </div>
      </div>
